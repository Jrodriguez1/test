...
public class push {
    ...
    private static final String appKey = "6201117e383a93bba181c79c";
    private static final String masterSecret = " 2392b371f7056a3e2759d5d2";
...
public class push {
    public static String sendPostRequest(String urlString, String jsondata){
        ...
        try {
            ...
            String auth = "NjIwMTExN2UzODNhOTNiYmExODFjNzljOjIzOTJiMzcxZjcwNTZhM2UyNzU5ZDVkMg==";
